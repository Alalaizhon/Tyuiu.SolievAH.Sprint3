...
using Tyuiu.SolievAH.Sprint3.Task4.V6.Lib;
    ...
    namespace Tyuiu.SolievAH.Sprint3.Task4.V6
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* На отрезке x, который принимает значения от -5 до 5, вычислить          *");
            Console.WriteLine("* значение функции y = x / (cos(x) - sin(x))                              *");
            Console.WriteLine("*                                                                         *");
            Console.WriteLine("***************************************************************************");
